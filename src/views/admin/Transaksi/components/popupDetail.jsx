...
export default function PopupEditStok(props) {
  ...
  return (
    <>
      <div className="bg-blue-700 bg-opacity-30 justify-center items-center flex overflow-x-hidden overflow-y-auto fixed inset-0 z-50 outline-none focus:outline-none">
